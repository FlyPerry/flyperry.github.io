!function (e, t) {
    ...
    var u = {
        updateSize: function () {
            ...
            var e = this.params, i = this.$wrapperEl, s = this.size, a = this.rtlTranslate, r = this.wrongRTL,
                ...
                h = i.children("." + this.params.slideClass), p = n ? this.virtual.slides.length : h.length, c = [],
            ...
            if (void 0 !== s) {
                ...
                "string" == typeof w && w.indexOf("%") >= 0 && (w = parseFloat(w.replace("%", "")) / 100 * s), this.virtualSize = -w, a ? h.css({
                    ...
                    marginRight: "",
                    marginBottom: ""
                }), e.slidesPerColumn > 1 && (E = Math.floor(p / e.slidesPerColumn) === p / this.params.slidesPerColumn ? p : Math.ceil(p / e.slidesPerColumn) * e.slidesPerColumn, "auto" !== e.slidesPerView && "row" === e.slidesPerColumnFill && (E = Math.max(E, e.slidesPerView * e.slidesPerColumn)));
                for (var C, M = e.slidesPerColumn, z = E / M, P = Math.floor(p / e.slidesPerColumn), k = 0; k < p; k += 1) {
                    S = 0;
                    var $ = h.eq(k);
                    if (e.slidesPerColumn > 1) {
                        var L = void 0, I = void 0, D = void 0;
                        "column" === e.slidesPerColumnFill ? (D = k - (I = Math.floor(k / M)) * M, (I > P || I === P && D === M - 1) && (D += 1) >= M && (D = 0, I += 1), L = I + D * E / M, $.css({
                            "-webkit-box-ordinal-group": L,
                            "-moz-box-ordinal-group": L,
                            "-ms-flex-order": L,
                            "-webkit-order": L,
                            order: L
                        })) : I = k - (D = Math.floor(k / z)) * z, $.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== D && e.spaceBetween && e.spaceBetween + "px").attr("data-swiper-column", I).attr("data-swiper-row", D)
                    }
                    if ("none" !== $.css("display")) {
                        if ("auto" === e.slidesPerView) {
                            var O = t.getComputedStyle($[0], null), A = $[0].style.transform,
                                H = $[0].style.webkitTransform;
                            if (A && ($[0].style.transform = "none"), H && ($[0].style.webkitTransform = "none"), e.roundLengths) S = this.isHorizontal() ? $.outerWidth(!0) : $.outerHeight(!0); else if (this.isHorizontal()) {
                                var N = parseFloat(O.getPropertyValue("width")),
                                    G = parseFloat(O.getPropertyValue("padding-left")),
                                    B = parseFloat(O.getPropertyValue("padding-right")),
                                    X = parseFloat(O.getPropertyValue("margin-left")),
                                    Y = parseFloat(O.getPropertyValue("margin-right")),
                                    V = O.getPropertyValue("box-sizing");
                                S = V && "border-box" === V ? N + X + Y : N + G + B + X + Y
                            } else {
                                var F = parseFloat(O.getPropertyValue("height")),
                                    ...
                                    j = parseFloat(O.getPropertyValue("margin-bottom")),
                                    U = O.getPropertyValue("box-sizing");
                                S = U && "border-box" === U ? F + W + j : F + R + q + W + j
                            }
                            A && ($[0].style.transform = A), H && ($[0].style.webkitTransform = H), e.roundLengths && (S = Math.floor(S))
                        } else S = (s - (e.slidesPerView - 1) * w) / e.slidesPerView, e.roundLengths && (S = Math.floor(S)), h[k] && (this.isHorizontal() ? h[k].style.width = S + "px" : h[k].style.height = S + "px");
                        h[k] && (h[k].swiperSlideSize = S), v.push(S), e.centeredSlides ? (y = y + S / 2 + x / 2 + w, 0 === x && 0 !== k && (y = y - s / 2 - w), 0 === k && (y = y - s / 2 - w), Math.abs(y) < .001 && (y = 0), e.roundLengths && (y = Math.floor(y)), T % e.slidesPerGroup == 0 && c.push(y), u.push(y)) : (e.roundLengths && (y = Math.floor(y)), T % e.slidesPerGroup == 0 && c.push(y), u.push(y), y = y + S + w), this.virtualSize += S + w, x = S, T += 1
                    }
                }
                if (this.virtualSize = Math.max(this.virtualSize, s) + m, a && r && ("slide" === e.effect || "coverflow" === e.effect) && i.css({width: this.virtualSize + e.spaceBetween + "px"}), d.flexbox && !e.setWrapperSize || (this.isHorizontal() ? i.css({width: this.virtualSize + e.spaceBetween + "px"}) : i.css({height: this.virtualSize + e.spaceBetween + "px"})), e.slidesPerColumn > 1 && (this.virtualSize = (S + e.spaceBetween) * E, this.virtualSize = Math.ceil(this.virtualSize / e.slidesPerColumn) - e.spaceBetween, this.isHorizontal() ? i.css({width: this.virtualSize + e.spaceBetween + "px"}) : i.css({height: this.virtualSize + e.spaceBetween + "px"}), e.centeredSlides)) {
                    ...
                    for (var K = 0; K < c.length; K += 1) {
                        var _ = c[K];
                        e.roundLengths && (_ = Math.floor(_)), c[K] < this.virtualSize + c[0] && C.push(_)
                    }
                    c = C
                }
                if (!e.centeredSlides) {
                    ...
                    for (var Z = 0; Z < c.length; Z += 1) {
                        var Q = c[Z];
                        e.roundLengths && (Q = Math.floor(Q)), c[Z] <= this.virtualSize - s && C.push(Q)
                    }
                    c = C, Math.floor(this.virtualSize - s) - Math.floor(c[c.length - 1]) > 1 && c.push(this.virtualSize - s)
                }
                if (0 === c.length && (c = [0]), 0 !== e.spaceBetween && (this.isHorizontal() ? a ? h.css({marginLeft: w + "px"}) : h.css({marginRight: w + "px"}) : h.css({marginBottom: w + "px"})), e.centerInsufficientSlides) {
                    var J = 0;
            ...
            if (0 !== i.length) {
                ...
                for (var n = 0; n < i.length; n += 1) {
                    ...
                    if (t.watchSlidesVisibility) {
                        ...
                        (d >= 0 && d < this.size || h > 0 && h <= this.size || d <= 0 && h >= this.size) && (this.visibleSlides.push(o), this.visibleSlidesIndexes.push(n), i.eq(n).addClass(t.slideVisibleClass))
                    }
                    o.progress = a ? -l : l
                }
    ...
    var T = {
                ...
                attachEvents: function () {
                    ...
                    this.onTouchStart = function (i) {
                        ...
                        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, p = s.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, s.freeMode) {
                            ...
                            for (var z = 0, P = t.slidesSizesGrid[0], k = 0; k < o.length; k += s.slidesPerGroup) void 0 !== o[k + s.slidesPerGroup] ? p >= o[k] && p < o[k + s.slidesPerGroup] && (z = k, P = o[k + s.slidesPerGroup] - o[k]) : p >= o[k] && (z = k, P = o[o.length - 1] - o[o.length - 2]);
                            var $ = (p - o[z]) / P;
                            if (u > s.longSwipesMs) {
        ...
        z = {name: "support", proto: {support: d}, static: {support: d}},
        P = {name: "browser", proto: {browser: h}, static: {browser: h}}, k = {
            ...
            update: function (e) {
                ...
                var C = [], M = [];
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove(); else for (var z = p; z <= c; z += 1) (z < x || z > T) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + z + '"]').remove();
        ...
        init: function () {
            ...
            if (t) {
                ...
                if (this.realIndex !== t.realIndex) {
                    ...
                    t.visibleSlidesIndexes.indexOf(s) < 0 && (t.params.centeredSlides ? s = s > a ? s - Math.floor(i / 2) + 1 : s + Math.floor(i / 2) - 1 : s > a && (s = s - i + 1), t.slideTo(s, e ? 0 : void 0))
                }
