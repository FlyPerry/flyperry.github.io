    ...
    <div class="row">
        <div class="col-md-6">
            <div class="items-form">
                ...
                <?= $form->field($model, 'category_id')->dropDownList(
                    ArrayHelper::map((array)$categories, 'id', 'title'),
                    ['prompt' => 'Выберите категорию', 'id' => 'category-dropdown']
                )->label(false); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= Html::activeCheckbox($model, 'active', ['labelOptions' => ['class' => 'btn-checkbox w-100 text-center'], 'uncheck' => 0, 'label' => 'Активно']) ?>
                        </div>
                        <div class="form-group">
                            <?= Html::activeCheckbox($model, 'hit', ['labelOptions' => ['class' => 'btn-checkbox w-100 text-center'], 'uncheck' => 0]) ?>
                        </div>
                        <div class="form-group">
                            <?= Html::activeCheckbox($model, 'new', ['labelOptions' => ['class' => 'btn-checkbox w-100 text-center'], 'uncheck' => 0]) ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?= Html::activeFileInput($model, 'imageFile', ['class' => 'form-control', 'id' => 'item-image']) ?>
